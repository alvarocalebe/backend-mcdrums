...
public class ProdutoFileService implements FileService {
    ...
    private final String PATH_USER = System.getProperty("user.home")
        ...
        + File.separator + "bateria" + File.separator;
    ...
    public void salvar(Long id, String nomeImagem, byte[] imagem) {
        BateriaCompleta bateriaCompleta = bateriaCompletaRepository.findById(id);

        try {
            String novoNomeImagem = salvarImagem(imagem, nomeImagem);
            bateriaCompleta.setNomeImagem(novoNomeImagem);
